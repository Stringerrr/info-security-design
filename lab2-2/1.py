...
if __name__ == '__main__':
    repo = MyEntityRepJson("entities.json")

    repo.add_object({"name": "Entity1", "value": 100})
    repo.add_object({"name": "Entity2", "value": 200})
    repo.save_to_file()
    ...
    repo.sort_by_field("value")
    repo.save_to_file()

    repo.update_object_by_id(1, {"value": 150})
    repo.save_to_file()
